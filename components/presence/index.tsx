...
const Presence: FunctionComponent<Props> = ({ id, name, checked, onChange, locale }) => {
    ...
    return(
        <div className={styles.container}>
            <div className={styles.labels}>
                <label>{translations[locale].presenceTitle}</label>
                <p>{translations[locale].presenceDescription}</p>
            </div>
